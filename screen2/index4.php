...
$sql1 = "SELECT * FROM mft WHERE feeder LIKE '%FANCY_BAZAR%' ORDER BY time_calc DESC";
$sql2 = "SELECT * FROM fancy_bazaar WHERE feeder LIKE '%FANCY_BAZAR%' ORDER BY open_time DESC";
...
<span>Close time: " . $row2['close_time'] . "</span><br>
    <span id='status4' hidden>Status:" . $row2['status'] . "</span><br>
    </div>";
    break;
}
mysqli_close($conn);
