...
$sql1 = "SELECT * FROM mft WHERE feeder LIKE '%STATION%' ORDER BY time DESC";
$sql2 = "SELECT * FROM fancy_bazaar WHERE feeder LIKE '%STATION%' ORDER BY open_time DESC";
...
while ($row1 = mysqli_fetch_array($result1)) {
    ...
    <span id='status6' hidden>Status:" . $row2['status'] . "</span><br>
    </div>";
    break;
}
mysqli_close($conn);
