...
$sql1 = "SELECT * FROM mft WHERE feeder LIKE '%MS_ROAD%' ORDER BY time_calc DESC";
$sql2 = "SELECT * FROM fancy_bazaar WHERE feeder LIKE '%MS_ROAD%' ORDER BY open_time DESC";

$result1 = mysqli_query($conn, $sql1);
$result2 = mysqli_query($conn, $sql2);

while ($row1 = mysqli_fetch_array($result1)) {
	echo "<div id='index1 style='position:absolute; left:300px''>
...
<span id='status1' hidden>Status:" . $row2['status'] . "</span><br>
</div>";
	break;
}
mysqli_close($conn);
